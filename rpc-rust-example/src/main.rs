    ...
    async_scoped::TokioScope::scope_and_block(|scope| {
        ...
        scope.spawn(async move {
            ...
            match res {
                TransportEvent::Message(bytes) => {
                    ...
                    let payload = Book::parse_from_bytes(&procedure_response.payload).unwrap();
                    println!(
        ...
        scope.spawn(async {
            ...
            server.set_handler(|port: &mut RpcServerPort| {
                ...
                codegen::BookServiceCodeGen::register_service(
                    port,
                    api::book_service::BookService {},
                )
            });
